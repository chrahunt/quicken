...
latex_documents = [
    (master_doc, 'quicken.tex', 'quicken Documentation',
     'Chris Hunt', 'manual'),
]
...
man_pages = [
    (master_doc, 'quicken', 'quicken Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'quicken', 'quicken Documentation',
     author, 'quicken', 'One line description of project.',
     'Miscellaneous'),
]
